...
<p>
  ...
  <?php
 // capturo la salida a partir de aqui
  ob_start(); ?>
...
//incluyo mi archivo de conexion 
include('../../Controlador/conex.php');

//capturo la referencia del forulario para la busqueda
...
//fin del contenido php

//paso como parametro el contenido de ob start a dmpdf
$dompdf = new DOMPDF();
